...
class QueryBuilder {
  ...
  parseValue(value, schemaPiece, datatype = this.get(schemaPiece.type)) {
    ...
    return schemaPiece.array ? this.arrayResolver(value, schemaPiece, datatype.resolver || (() => value)) : typeof datatype.resolver === 'function' ? datatype.resolver(value, schemaPiece) : value;
  }
}
