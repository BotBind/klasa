...
Timestamp.Y = Timestamp.YY = time => String(time.getFullYear()).slice(0, 2);

Timestamp.YYY = Timestamp.YYYY = time => String(time.getFullYear());
...
Timestamp.MMM = Timestamp.MMMM = time => MONTHS[time.getMonth()];

Timestamp.D = time => String(time.getDate());

Timestamp.DD = time => String(time.getDate()).padStart(2, '0');

Timestamp.DDD = Timestamp.DDDD = time => {
