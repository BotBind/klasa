...
class Command extends AliasPiece {
  ...
  constructor(client, store, file, directory, options = {}) {
     ...
     * @returns {string}
     */
    this.description = isFunction(options.description) ? (language = this.client.languages.default) => options.description(language) : options.description;
     ...
     * @returns {string}
     */
    this.extendedHelp = isFunction(options.extendedHelp) ? (language = this.client.languages.default) => options.extendedHelp(language) : options.extendedHelp;
