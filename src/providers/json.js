const { Provider, util } = require('@botbind/klasa');
...
module.exports = class extends Provider {
   ...
   */
  deleteTable(table) {
    return this.hasTable(table).then(exists => exists ? fs.emptyDir(resolve(this.baseDirectory, table)).then(() => fs.remove(resolve(this.baseDirectory, table))) : null);
  }
