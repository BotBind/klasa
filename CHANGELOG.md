...
- [[#179](https://github.com/dirigeants/klasa/pull/179)] Fixed `null` values in _updateMany_'s pattern not updating nested keys plus individual queries. (kyranet)
...
- [[#182](https://github.com/dirigeants/klasa/pull/182)] Fixed MessageOptions being not correctly applied to the _send_ aliases. (bdistin)
